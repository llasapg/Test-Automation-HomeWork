...
namespace ClassLibrary1
{
    ...
    public class Rozetka
    {
        ...
        private IWebElement BuyButton { get { return driver.FindElement(By.CssSelector("#price_container > div.detail-buy-btn-wrap > div > form > span > span > button")); } }
        ...
        public void BuyLepTop()
        {
            if(BuyButton.Displayed)
                BuyButton.Click();
        }
    }
